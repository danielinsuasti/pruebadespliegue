...
var jwtCheck = jwt({
  secret: jwks.expressJwtSecret({
    ...
    jwksUri: 'https://misiontic-concesionario-motos.us.auth0.com/.well-known/jwks.json', //MODIFICADO
  }),
  audience: 'api-autenticacion-concesionario-motos',   //MODIFICADO
  issuer: 'https://misiontic-concesionario-motos.us.auth0.com/', //MODIFICADO
  algorithms: ['RS256'],
});
